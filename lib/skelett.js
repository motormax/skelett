...
class Skelett {
  ...
  create(configuration = {}) {
    if (!this._created) {
      ...
      if (!_.isFinite(this._configuration.server.port)
        || this._configuration.server.port % 1 !== 0) {
      ...
      this.connections = require('./mongodb/connection')(
        this._configuration.connections
      )
